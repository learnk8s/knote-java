...
In this article, you will create an EKS cluster and deploy a Spring Boot application called Knote — a simple note-taking application.
...
- You wrote a note-taking application in Spring Boot
